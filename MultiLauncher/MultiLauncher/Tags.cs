...
namespace MultiLauncher
{
    abstract public class Tags
    {
        ...
        public readonly static string[] mainTags = { "Whitelist", "PvP", "PvE", "Creative", "Survival" };
        public readonly static string[] tags = { "Minigames", "Economy", "Factions", "CTF", "Hunger games", "Skyblock", "RP", "Action RPG", "Parkour" };
    }
}
